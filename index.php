...
<div class="w3-padding-large" id="main">
  ...
  <div class="w3-padding-64 w3-content" id="photos">
    ...
    <div class="w3-row-padding" style="margin:0 16px">
      ...
      <div class="w3-half">
        <a href="lago_1.jpg" rel="shadowbox[plants];height=496;width=720"><img src="lago_1.jpg" style="width:45%"></a>
        <a href="lago_2.jpg" rel="shadowbox[plants];height=496;width=720"> <img src="lago_2.jpg" style="width:45%"></a>
        <a href="lago_3.jpg" rel="shadowbox[plants];height=496;width=720"><img src="lago_3.jpg" style="width:45%"></a>
        <a href="quadra.jpg" rel="shadowbox[plants];height=496;width=720"><img src="quadra.jpg" style="width:45%"></a>
...
if (isset($_POST['BTEnvia'])) {
  ...
  //==================================================== 
  $email_remetente = "contato@sitiovovoclarinha.com.br"; // deve ser uma conta de email do seu dominio 
  //====================================================
  
  //Configurações do email, ajustar conforme necessidade
  //==================================================== 
  $email_destinatario = "contato@sitiovovoclarinha.com.br"; // pode ser qualquer email que receberá as mensagens
  $email_reply = "$email"; 
  $email_assunto = "Contato do site Sítio Vovó Clarinha"; // Este será o assunto da mensagem
  //====================================================
...
?>
    <form action="<? $PHP_SELF; ?>" method="POST">
      ...
      <p><input class="w3-input w3-padding-16" type="text" placeholder="Telefone" required name="telefone"></p>
